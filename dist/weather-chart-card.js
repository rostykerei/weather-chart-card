            ...
            <div>
                ...
                <div class="page-container ${this.currentPage === 'card' ? 'active' : ''}">
                    ...
                    <div class="time-container">
                        ...
                        <div class="switch-right checkbox-container"
                             style="${this._config.show_time ? 'display: flex;' : 'display: none;'}">
                            <ha-checkbox
                    ...
                    <div class="icon-container">
                        ...
                        <div class="switch-right radio-container"
                             style="${this._config.animated_icons ? 'display: flex;' : 'display: none;'}">
                            <ha-radio
                                    name="icon_style"
                                    value="style1"
...
class WeatherChartCard extends s {
    ...
    renderMain({config, sun, weather, temperature, feels_like, description} = this) {
        ...
        const iconHtml = config.animated_icons || config.icons
            ...
            : x`
                    <ha-icon icon="${this.getWeatherIcon(weather.state, sun.state)}"></ha-icon>`;
                ...
                ${((showHumidity && humidity !== undefined) || (showPressure && dPressure !== undefined) || (showDewpoint && dew_point !== undefined) || (showVisibility && visibility !== undefined)) ? x`
                    <div>
                        ...
                        ${showDewpoint && dew_point !== undefined ? x`
                            <ha-icon
                                    icon="hass:thermometer-water"></ha-icon> ${dew_point} ${this.weather.attributes.temperature_unit}
                            <br>
                        ` : ''}
                ...
                ${((showWindDirection && windDirection !== undefined) || (showWindSpeed && dWindSpeed !== undefined)) ? x`
                    <div>
                        ${showWindDirection && windDirection !== undefined ? x`
                            <ha-icon
                                    icon="hass:${this.getWindDirIcon(windDirection)}"></ha-icon> ${this.getWindDir(windDirection)}
                            <br>
                        ` : ''}
            ...
            <div class="conditions" @click="${(e) => this.showMoreInfo(config.entity)}">
                ${forecast.map((item) => {
                    ...
                    if (config.animated_icons || config.icons) {
                        ...
                        iconHtml = x`
                            <ha-icon icon="${this.getWeatherIcon(condition, sun.state)}"></ha-icon>`;
                    }
                        ...
                        return x`
                            <div class="wind-detail">
                                <ha-icon class="wind-icon"
                                         icon="hass:${this.getWindDirIcon(item.wind_bearing)}"></ha-icon>
